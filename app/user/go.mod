module github.com/trashwbin/gomall-demo/app/user

go 1.23.4

replace (
	github.com/apache/thrift => github.com/apache/thrift v0.13.0
	// go mod tidy 时 如果远端找不到，就会使用本地的
	github.com/trashwbin/gomall-demo/rpc_gen => ../../rpc_gen
)

replace github.com/trashwbin/gomall-demo/common => ../../common
...
require (
	...
	github.com/trashwbin/gomall-demo/common v0.0.0-00010101000000-000000000000
	github.com/trashwbin/gomall-demo/rpc_gen v0.0.0-00010101000000-000000000000
